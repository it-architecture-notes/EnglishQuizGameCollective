...
| `sentence_builder_quiz_body.dart` | `ConvoTemplate-SentenceBuilder`: immediate 3×3 grid, tap tokens in order. |
...
| `word_pairs_quiz_body.dart` | `ConvoTemplate-WordPairs`: left column + scrambled right column, tap to pair. |
