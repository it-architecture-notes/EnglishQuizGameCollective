...
**Why:** The user directly overrode a grammar-progression flag raised per `all-ai-common/skills/audit-quiz-level/SKILL.md`, calling the idiomatic version better than the strictly-compliant rewrite.
