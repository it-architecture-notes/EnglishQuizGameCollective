...
- Parse `all-ai-common/references/activities/activities.txt` for the sequence of activities (starting from `waking-up`).
...
- Activity Source: `all-ai-common/references/activities/activities.txt`
