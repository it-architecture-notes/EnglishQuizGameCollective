...
| `-o path.json` | Save under `all-ai-common/output/` |
...
Under `all-ai-common/references/final words/`:
...
`all-ai-common/references/remove-word-list-references/langeek-500-most-common-nouns.txt`
...
2. `python3 tools/gather_prior_level_words.py bedroom --format json -o all-ai-common/output/bedroom-prior-words.json`
...
**Deeper pass:** use **`all-ai-common/skills/improve-level-vocabulary/SKILL.md`** for ranked unused + misplaced-later analysis and full Recommended swaps blocks.
...
Full schema: `all-ai-common/context/page-designs-and-templates.md`
